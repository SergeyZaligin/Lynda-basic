...
<?php
  if (isset($_POST['submit'])) {
    ...
    $menu_name = mysql_injection($_POST["menu_name"]);
...
<div id="main">
  ...
  <div id="page">
    ...
    &nbsp;
    &nbsp;
    <a href="delete_subject.php?subject=<?php echo urlencode($current_subject["id"]); ?>" onclick =
"return confirm('Are you shure?');">Delete subject</a>
  </div>
</div>
